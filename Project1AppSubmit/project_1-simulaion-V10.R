  ...
  navbarPage(title = "Project 1",
             ...
             navbarMenu(title = "Model Data",
                        tabPanel(title = "Vaccine Parameters",
                                 ...
                                 mainPanel(
                                   ...
                                   hr(),
                                   wellPanel(
                                   p("Set various vaccine characteristics and supply for the simulator.")
                                   ),
                                   hr(),
                                   wellPanel(
                                     h2("Moderna"),
                                     hr(),
                                     p("Set various Moderna vaccine characteristics and supply for the simulator."),
                                     hr(),
                                   ...
                                   wellPanel(
                                     h2("Pfizer"),
                                     hr(),
                                     p("Set various Pfizer vaccine characteristics and supply for the simulator."),
                                     hr(),
                        ...
                        tabPanel(title = "Baseline Population",
                                 ...
                                 mainPanel(
                                   ...
                                   hr(),
                                   wellPanel(
                                   p("These variables feed into the creation of a new fate table via the ''Reset'' function on the ''Dash Board'' and are not otherwise used by the simulation function.")
                                   ),
                                   hr(),
                                   wellPanel(
                                     h2("Global Simulation Variables"),
                                     hr(),
                                     p("Set the number of individuals for which a fate table should be constucted."),
                                     hr(),
                                   ...
                                   wellPanel(
                                     ...
                                     hr(),
                                     p("Set the proportion of the population who initially fall in to the various ''SEIR'' Categories (see ''Model Development / Assumptions'' under the ''About'' drop down menu)."),
                                     hr(),
                                   ...
                                   wellPanel(
                                     ...
                                     hr(),
                                     p("Set the proportion of people to be randomly ditributed between the available groups."),
                                     hr(),
                                     numericInput(
             ...
             tabPanel(title = "Vaccine Strategy",
                      ...
                      wellPanel(
                        h2("Dose Division"),
                        hr(),
                        p("This allows for the division of doses proportionately to various groups. If numbers input add to a value greater than 1 are entered, the numbers are treated as ''weights.'' If the numbers add to less than one, a vaccine reserve is created."),
                        hr(),
                        sliderInput(
                          inputId = "doseProp1",
                          label = "General Population:",
                      ...
                      wellPanel(
                        ...
                        hr(),
                        p("This allows the user to select which age groups will be vaccinated first."),
                        hr(),
             ...
             navbarMenu(title = "About",
                        ...
                        tabPanel(title = "About",
                                 ...
                                 hr(),
                                 wellPanel(
                                   h2("Details / Definitions:"),
                                   hr(),
                                   fluidRow(
                                     column(11, offset = 1,
                                            h3("Purpose"),
                                            p("The purpose of this code is to provide support with respect to the roll out of COVID vaccines in Ontario. Provided is a highly customizable simulator that allows the interaction of 5 groups with demography representative of Ontario but with different infection dynamics. This specifically allows stakeholders to identify where vaccines should be introduced to interrupt the flow of new infections."),
                                            h3("Best"),
                                            p("The best outcome is conceptualized as resulting from the generation of the fewest infections (see ''Model Development / Assumptions'' under the ''About'' drop down menu). The simulator also allows users to visualize deaths as well as others have identified this as a reasonable metric. A more complete discussion can be seen in the ''Model Development / Assumptions'' under the ''About'' drop down menu."),
                                            h3("Complete"),
                                            p("The simulator has default values to simulate an unstructured vaccination strategy from March through to September 2021. Although the quatity of vaccines can be adjusted to see completion of vaccination at that time (i.e., the delivery of 2 vaccines doses of the same vaccine to every member of the population), more realistic values have been set as the defaults. My definition of completion of the vaccine campaign is therefore simply the state of vaccinations in September 2021."),
                                            h3("Initial Case"),
                                            p("The openning window displays a simualation where vaccine doses have been seperated by their usual 4 and 3 weeks (for Moderna and Pfizer vaccine's respectively - primary/red) or by the United States Center for Disease Control suggested maximum of 6 weeks (Secondary/Blue). Simulations often result in showing an increasing benefit of the latter strategy if the incremental benefit of a second vaccine shot over the first as measured by susceptibility change is small (e.g., first dose gives 93% immunity and the second gives 95% immunity)."),
                                            h3("Results"),
                                            p("After running the cases (see ''Model Development / Assumptions'' under the ''About'' drop down menu) you will see an approach of more widely split doses and a focus on vaccinating the population segment that has the most varried interactions (e.g., hospital and long term care workers as opposed to their patients) would be ''best'' given what is currently known of COVID19 and the its approved vaccines in Canada.")
                                     ))),
                                 hr(),
                                 wellPanel(
